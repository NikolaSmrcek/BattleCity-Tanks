...
exports.init = ({ io, usersController, queueController }) => {
    ...
    io.on('connection', socket => {
        ...
        socket.on(sapis.enterQueue, data => queueSapi[sapis.enterQueue]({socket, data, emitter, queueController, usersController}));
